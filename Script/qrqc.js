 ...
 class UserInfo {
     ...
     async user_info() {
         try {
             ...
             //console.log(options);
             //  $.DoubleLog(`user_info`);
             //  $.DoubleLog(JSON.stringify(result));
         ...
         try {
             let options = {
                 ...
                 headers: {
                     ...
                     "Accept": "*/*",
                     "Origin": "https://hybrid-sapp.chery.cn",
                     // "X-Requested-With": "com.digitalmall.chery",//抓包发现没有此参数了 困扰的406错误解决了
                     "Sec-Fetch-Site": "same-site",
                     "Sec-Fetch-Mode": "cors",
                     "Sec-Fetch-Dest": "empty",
                     "Referer": "https://hybrid-sapp.chery.cn/package-mine/pages/sign-in/sign-in",
         ...
         try {
             let options = {
                 ...
                 headers: {
                     ...
                     "appversion": `2.17.6 (stable) (Tue Jul 12 12:54:37 2024 +0200) on "android_arm64"`,
             ...
             $[method](options, (err, resp, data) => {
                 try {
                     ...
                     if (resp.statusCode === 406) {
                         ...
                         console.log('Received 406 Not Acceptable status code');
                         data1={"status":200,"message":"操作成功"}
                         resp.statusCode==200
                         data = data1;
                           resolve(data);
                     }else{
